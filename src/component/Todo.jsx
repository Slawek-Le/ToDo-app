            ...
            <ul className="list-group mx-auto" style={{maxWidth : "600px"}}>
                {todos.map((todo, index) => (
                    <li key={index} className="list-group-item d-flex justify-content-between">
                        ...
                        <div>
                            <button onClick={() => handleEditTodo(index)} className="btn btn-warning btm-sm me-2">edit</button>
                            <button onClick={() => handleDeleteTodo(index)} className="btn btn-danger btm-sm me-2">delete</button>
                        </div>
                    </li>
                ))}
            </ul>
